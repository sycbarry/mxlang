...
public class MXTestHttpApi extends Instance {
    ...
    public MXTestHttpApi(Class klass, String endpoint, String apiToken, String maxAuth, String userName, String password) {
        super(klass);
