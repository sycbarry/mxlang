...
//import static com.sms.lang.RuntimeError.*;
package lang;
import static lang.TokenType.*;
import static lang.RuntimeError.*;
...
public abstract class Stmt {
    ...
    static class Test extends Stmt {
        Test(Token name, Stmt.Function function) {
            this.name = name;
    ...
    static class While extends Stmt {
        While(Expr condition, Stmt body) { // or block
